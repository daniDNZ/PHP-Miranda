...
<head>
  ...
  <title>Hotel Miranda - Offers</title>
</head>
...
<body>
  ...
  <main>
    <section class="section banner px-20">
      ...
      <div class="breadcrumb">
        <a href="../index.html" class="a breadcrumb__a">Home</a><span class="breadcrumb__line">|</span><span
          class="breadcrumb__current">Offers</span>
      </div>
    </section>
    <section class="section px-20">
      <div class="offer">
        <div class="offer__img">
          <div class="price price--previous offer__previous-price">
            <span class="price__amount">$500</span><span class="price__night">/Night</span>
          </div>
          <div class="price price--offer offer__new-price">
        ...
        <div class="px-20">
          ...
          <p class="section__p">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
            incididunt
            ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
            aliquip ex ea commodo consequat. Duis aute irure dolor in reprehend erit in voluptate velit esse cillum
            dolore
            eu fugiat nulla pariatur.</p>
          <div class="amenities-container amenities-container--offer">
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--ac"></i><span class="amenitie__name">Air
                conditioner</span></div>
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--breakfast"></i><span
                class="amenitie__name">Breakfast</span></div>
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--cleaning"></i><span
                class="amenitie__name">Cleaning</span></div>
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--grocery"></i><span
                class="amenitie__name">Grocery</span></div>
            ...
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--wifi"></i><span class="amenitie__name">High
                Speed WiFi</span></div>
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--kitchen"></i><span
                class="amenitie__name">Kitchen</span></div>
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--shower"></i><span
                class="amenitie__name">Shower</span></div>
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--bed"></i><span class="amenitie__name">Single
                bed</span></div>
            <div class="amenitie"><i class="amenitie__icon amenitie__icon--towels"></i><span
                class="amenitie__name">Towels</span></div>
          </div>
          <a href="room-details.html" class="button offer">book now</a>
        </div>
      </div>
      <div class="offer">
        <div class="offer__img">
    ...
    <section class="section popular-rooms">
      <h2 class="h2 popular-rooms__h2">Popular List</h2>
      <h3 class="h3 popular-rooms__h3">Popular Rooms</h3>
      <div class="button-container px-20">
        <div class="swiper-button-prev swiper-button-prev--out-wide"></div>
        <div class="swiper-button-next swiper-button-next--out-wide"></div>
        <div class="home-rooms">
          ...
          <div class="price price--booking">
            <div>
              <span class="price__amount price__amount--same-size">$345</span><span
                class="price__night price__night--same-size">/Night</span>
            </div>
